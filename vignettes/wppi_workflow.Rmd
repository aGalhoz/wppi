...
The `wppi` package depends on the `OmnipathR` package. Since several 
developments were made since version 2, an update of the git version is 
recommended:

```{omnipath, results='hide'}
require(devtools)
