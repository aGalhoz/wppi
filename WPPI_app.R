# General function to run all auxiliar functions in WPPI_functions and Annot_functions

source("WPPI_packages.R")
source("WPPI_data.R")
source("PPI_functions.R")
source("Annot_functions.R")

score_candidate_genes_from_PPI <- function(genes_interest,
                                           HPO_interest,
